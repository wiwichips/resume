...
\section{Technical Skills}
  \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
      \textbf{Languages}{: JavaScript, Python, Rust, C, Golang, Shell/Bash, Java, SQL, GraphQL} \\
...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Software Developer / Team Lead API \& Toolchains}{May 2023 -- Present}
      {\href{https://distributive.network/}{\underline{Distributive}} (Formerly known as Kings Distributed Systems)}{Kingston, ON}
      \resumeItemListStart 
        \resumeItem{Designed and built a WebHook server in \textbf{Go/Golang} for accessing AI inference predictions from \href{https://distributive.network/diana}{\underline{Diana}}}
        ...
        \resumeItem{Created the \textbf{Pyodide} Worktime, enabling distributed \textbf{Python} to execute in a \textbf{WASM} runtime}
  ...
  \resumeSubHeadingListStart
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Try it out! \href{https://wiwichips.github.io/imgprobox/}{\underline{wiwichips.github.io/imgprobox/}}}
      \resumeItemListEnd
