...
\section{Extracurriculars \& Awards}
  \resumeSubHeadingListStart
    ...
    %%    \resumeItem{Facilitated events, judged hackathon submissions, liasoned with business partners and lead the marketing}
      \resumeItemListEnd
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Maintaining an online community used by 1400+ Bachelor of Computing students at the University of Guelph to share class notes and collaborate with each other within the rules of the university}
      \resumeItemListEnd
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Developed \href{https://github.com/wiwichips/gcb}{Gunkstribute}, an app that utilizes parallel computing to classify images with Tensorflow, in 36 hours}
      \resumeItemListEnd
