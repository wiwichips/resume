...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart 
        \resumeItem{In order to automate the deactivation of security vulnerability scanners, I wrote Go code that appropriately removes data by sending Kafka and RabbitMQ messages}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Implemented a scraping feature for payments alloing a third party to make a commission off of paid compute}
...
\section{Extracurriculars \& Awards}
  \resumeSubHeadingListStart
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Co-founded a \href{https://hackthejob.ca}{hackathon organization} that has helped over 200 participants from 10+ universities learn industry tools and advance their careers}
        \resumeItem{Facilitated events, \href{https://youtu.be/yMrGF7CUkKs?t=2631}{judged hackathon submissions}, liasoned with corporate sponors and lead marketing}
      \resumeItemListEnd
