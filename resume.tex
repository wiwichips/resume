...
\section{Work Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart 
        \resumeItem{Designed and built a Webhook server in \textbf{Golang} for accessing \textbf{AI inferences} deployed to \href{https://distributive.network/diana}{\underline{Diana}}}
