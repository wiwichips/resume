...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{center}
	\headerfirstnamestyle{Will} \headerlastnamestyle{Pringle} \\
	\vspace{2mm}
	{\faEnvelope\ willkantorpringle@gmail.com} | {\faGithub\ github.com/wiwichips} | {\faLinkedin\ linkedin.com/in/will-pringle}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
